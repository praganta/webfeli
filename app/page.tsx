        ...
        <div style={{ position: "relative", zIndex: 2, display: "flex", flexDirection: "column" }}>
          ...
          >
            ...
            {phase === 3 && (
              ...
              >
                <FinalHeart onRestart={restartToEnvelope} />
              </div>
            )}
            ...
            {phase === 2 && (
              <div
                style={{
                  ...
                  alignContent: "start",
                  opacity: isSwitching ? 0 : 1,
                  transform: isSwitching ? "translateY(8px)" : "translateY(0)",
                    ...
                    >
                      ...
                      <div style={{ display: "grid", gap: 8 }}>
                        ...
                        >
                          ...
                          <span style={{ color: "rgba(255,77,141,0.95)", fontWeight: 900 }}>Felicia</span>
          ...
          <div
            style={{
              ...
              paddingBottom: `calc(${isMobile ? 12 : 14}px + env(safe-area-inset-bottom))`,
